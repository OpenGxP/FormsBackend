            ...
            'navigation': {'admin_ngxp': {'title': 'Non-GxP Administration',
                                          'subjects': {'ldap': {'title': 'LDAP',
                                                       ...
                                                       'settings': {'title': 'Settings',
                                                                    ...
                                                                    'version': False,
                                                                    'status': None},
                                                       'securitykeys': {'title': 'Security Keys',
                                                                        'url': {'abs': reverse('securitykeys-list',
                                                                                               request=request),
                                                                                'rel': 'admin/securitykeys'},
                                                                        'log': {'abs': reverse('securitykeys-log-list',
                                                                                               request=request),
                                                                                'rel': 'logs/securitykeys'},
                                                                        'post': True,
                                                                        'patch': False,
                                                                        'delete': True,
                                                                        'version': False,
                           ...
                           'admin_gxp': {'title': 'GxP Administration',
                                         'subjects': {'roles': {'title': 'Roles',
                                                      ...
                                                      'webhooks': {'title': 'WebHooks',
                                                                   'url': {'abs': reverse('webhooks-list',
                                                                                          request=request),
                                                                           'rel': 'admin/webhooks'},
                                                                   'log': {'abs': reverse('webhooks-log-list',
                                                                                          request=request),
                                                                           'rel': 'logs/webhooks'},
                                                                   'post': True,
                                                                   'patch': True,
                                    ...
                                    'subjects': {'central': {'title': 'Central',
                                                 ...
                                                 'users': {'title': 'Users',
                                                           'url': {'abs': reverse('users-log-list', request=request),
                                                                   'rel': 'logs/users'}},
                                                 'webhooks': {'title': 'WebHooks',
                                                              'url': {'abs': reverse('webhooks-log-list',
                                                                                     request=request),
                                                                      'rel': 'logs/webhooks'}},
                                                 'tags': {'title': 'Tags',
                                                 ...
                                                 'settings': {'title': 'Settings',
                                                              'url': {'abs': reverse('settings-log-list',
                                                                      ...
                                                                      'rel': 'logs/settings'}},
                                                 'securitykeys': {'title': 'Security Keys',
                                                                  'url': {'abs': reverse('securitykeys-log-list',
                                                                                         request=request),
                                                                          'rel': 'logs/securitykeys'}},
